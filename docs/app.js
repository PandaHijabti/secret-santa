...
goBtn.addEventListener("click", async () => {
  ...
  try {
    // ✅ Exemple: tu envoies le prénom du participant
    // Adapte les champs EXACTEMENT à ce que ta function attend.
    ...
    // Ici, tu affiches le résultat comme tu veux
    alert(text);
  } catch (e) {
    alert("Erreur réseau / CORS. Dis-moi le message exact si ça arrive.");
    console.error(e);
  }
});
